...
let ObjectID = require("mongodb").ObjectID; // needed for testcases
let fetch = require("node-fetch"); // quick way to make request
...
describe("Jokes API", function () {
  let server;
  //Start Server
  before(function (done) { // runs before all tests
